<template>
  <div class="container">
    ...
    <v-row class="d-flex mx-0 no_rowgap">
      <div class="box mb-0 pl-0 col-md-6 col-sm-12" v-if="data.material">
      ...
      <div class="box mb-0 pl-0 col-md-6 col-sm-12" v-if="data.school">
        <h5>School:</h5>
        <div class="box_inner">
    ...
    <v-row class="d-flex mx-0 pt-3 mb-5">
      <div class="col-md-3 col-sm-4 pl-0" v-if="data.level">
        <h5>Level to get:</h5>
        <p class="mb-0">Level {{ data.level }}</p>
      </div>
      <div class="col-md-3 col-sm-4 pl-0" v-if="data.range">
        <h5>Spell range:</h5>
        <p class="mb-0">{{ data.range }}</p>
      </div>
      <div class="col-md-3 col-sm-4 pl-0" v-if="data.ritual">
        <h5>Need Ritual:</h5>
        <p class="mb-0">{{ data.ritual }}</p>
      </div>
      <div class="col-md-3 col-sm-4 pl-0" v-if="data.duration">
        <h5>Duration:</h5>
      ...
      <div class="col-md-3 col-sm-4 pl-0" v-if="data.casting_time">
        <h5>Casting time:</h5>
        <p class="mb-0">{{ data.casting_time }}</p>
      </div>
      <div class="col-md-3 col-sm-4 pl-0" v-if="data.components">
        <h5>Components:</h5>
        <p class="mb-0">
